...
if (isset($_POST['AdminLoginBtn'])) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) == 1) {
            ...
            $_SESSION['message'] = "Logged In Succesfully as a Admn";
            header("Location: index.php");
            exit();
        } else {

            $_SESSION['message'] = "Checking Credential !!!";
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <!-- <span class="padding-bottom--15">Admin</span> -->
                            <h1 class="text-center"><a href="http://blog.stackfindover.com/" rel="dofollow">Admin</a>
                            </h1>
